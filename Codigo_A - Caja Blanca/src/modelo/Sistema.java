...
public class Sistema
{
	...
	{ // PRECONDICON DIRECCION VALIDA Y QUE EXISTA EN LA FACTURA
	...
	/**
	 * <b>Pre: </b> El parametro persona debe ser distinto de null, cadena vacia y
	 * debe existir en la lista de facturas. <b>Post: </b> Se devuelve un string no
	 * vacio con la factura de la persona.
	 * 
	...
	{
		verificaInvariante();
		assert persona != null : "La persona no debe ser null";
		assert !persona.isEmpty() : "La persona no debe ser cadena vacia";
		assert this.listaFacturas.get(persona) != null : "La persona debe estar en la lista";
		String personaAux = persona;
		HashMap<String, Factura> listaFacturasAux = new HashMap<String, Factura>();
		listaFacturasAux.putAll(this.listaFacturas);
		...
		assert this.listaFacturas.equals(listaFacturasAux) : "La lista de facturas no debe modificarse";
		assert persona == personaAux : "La persona no debe modificarse";
		assert !sb.toString().isEmpty() : "Se debe devolver un String no vacio";
		verificaInvariante();
		return sb.toString();
	}
	...
	{
		assert this.listaFacturas != null : "La lista no debe ser null";
	}
